...
public class TestDb extends AndroidTestCase {
    ...
    */
    public long testLocationTable() {
        ...
        // query if you like)
        TestUtilities.validateCurrentRecord("location query validation failed", cursor, contentValues);
    ...
    public void testWeatherTable() {
        ...
        assertFalse("location not inserted", locationRowId == -1L);
        ...
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)
        TestUtilities.validateCurrentRecord("weather entry validation failed", cursor, weatherValues);
        assertFalse(cursor.moveToNext());
